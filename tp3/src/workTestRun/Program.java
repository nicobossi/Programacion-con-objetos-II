...
public class Program {
	...
	public static void main(String[] args) {
		...
		aTeam.addPerson(new Person("Fernando", new GregorianCalendar(2000, 11, 12)));
		aTeam.addPerson(new Person("Andrés", new GregorianCalendar(2002, 7, 2)));
		aTeam.addPerson(new Person("Ahinco", new GregorianCalendar(1995, 8, 1)));
